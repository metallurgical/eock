...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2016 at 04:57 PM
...
(14, 3, '2016-01-04 21:40:43', '11.20', '0000-00-00', 'PENDING');
...
(2, 'Nasi Lemak1', 'Food', '6.00', 76, 'Hot Product', 1),
(3, 'Pensel', 'Stationary', '1.20', 188, 'Normal', 1),
(15, 'sadad', 'Drink', '5.00', 1, 'eeee', 1),
...
--
ALTER TABLE `product_order`
MODIFY `po_id` int(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `service_files`
MODIFY `service_file_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
