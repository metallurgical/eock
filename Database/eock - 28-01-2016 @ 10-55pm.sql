...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2016 at 03:54 PM
...
(16, 1, '2016-01-15 21:38:59', '12.00', '0000-00-00', 'PENDING'),
(17, 1, '2015-11-19 22:44:42', '6.00', '0000-00-00', 'PENDING'),
(18, 1, '2016-02-18 22:49:10', '74.40', '0000-00-00', 'PENDING'),
(19, 1, '2016-01-19 00:25:45', '17.00', '0000-00-00', 'PENDING'),
(20, 1, '2016-03-06 00:42:47', '5.00', '0000-00-00', 'PENDING');
...
(2, 'Nasi Lemak1', 'Food', '6.00', 726, 'Hot Product', 1),
(3, 'Pensel', 'Stationary', '1.20', 186, 'Normal', 1),
(15, 'sadad', 'Drink', '5.00', 0, 'eeee', 1),
(16, 'sadad1', 'Drink', '5.00', 1, 'eeee', 1);
...
`service_id` int(5) NOT NULL,
  ...
  `service_total_price` varchar(50) NOT NULL,
  `service_status` int(5) NOT NULL,
  `servis_date_created` datetime NOT NULL
...
`service_file_id` int(5) NOT NULL,
  `service_id` int(5) NOT NULL,
  `service_file_copy` int(11) NOT NULL,
  `service_file_page` int(11) NOT NULL,
  `service_file_cat` varchar(50) NOT NULL,
  `service_file_color` varchar(50) NOT NULL,
  `service_file_price` varchar(50) NOT NULL,
...
ALTER TABLE `service_files`
 ADD PRIMARY KEY (`service_file_id`), ADD KEY `service_id` (`service_id`);
...
--
ALTER TABLE `product_order`
MODIFY `po_id` int(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=39;
--
-- AUTO_INCREMENT for table `services`
--
ALTER TABLE `services`
MODIFY `service_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `service_files`
--
ALTER TABLE `service_files`
MODIFY `service_file_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `service_files`
ADD CONSTRAINT `service_files_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`) ON DELETE CASCADE ON UPDATE CASCADE;
