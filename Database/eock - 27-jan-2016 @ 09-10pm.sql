...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2016 at 02:10 PM
...
--
ALTER TABLE `services`
MODIFY `service_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `service_files`
--
ALTER TABLE `service_files`
MODIFY `service_file_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
