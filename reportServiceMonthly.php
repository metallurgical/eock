...
if( isset( $_POST['search'] ) ) {
	...
	extract( $_POST );
	$today = $date_search;
	$sql = "SELECT SUM(service_total_price) as totalPrice, MONTH( servis_date_created ) AS bulan FROM `services` WHERE YEAR(servis_date_created) = $today GROUP BY bulan";
...
<h4 align="center">Monthly report Services</h4>	
<br />
<div align="center">
